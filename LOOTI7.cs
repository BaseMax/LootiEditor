///////////////////////////////////////////////////
/// Luftkatze Looti text editor for COSMOS OS   ///
/// Version 7                                   ///
///////////////////////////////////////////////////

public static string Kedit(string PATH, bool colors)
        {
            if (!File.Exists(@PATH))
            {
                File.Create(@PATH);
            ...
            for (; ; )
            {
                ...
                Console.Write("ESC EXIT | F1 SAVE | F2 OPEN | F3 NEW | F4 COLORS");
                ...
                {
                    File.Create("bufor.lti");
                    File.AppendAllText("bufor.lti", tosav);
                    Kedit("bufor.lti", false);
                    File.Delete("bufor.lti");
                    return null;
                }
